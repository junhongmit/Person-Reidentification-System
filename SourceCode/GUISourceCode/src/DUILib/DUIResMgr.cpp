...
//VOID CResMgr::NewImage(const CDUIString& strName, const CDUIString& strFileName)
//{
//	CRefPtr<CResourceImageData> pData = new CResourceImageData;
//	if (!pData.IsNull())
//	{
//		pData->m_strName = strName;
//		pData->m_strFileType = _T("file");
//		pData->m_strFileName = strFileName;
//		pData->m_strCount = _T("1");
//
//		if (pData->m_strName.size() > 0)
//		{
//			m_mapImage.insert(std::make_pair(pData->m_strName, pData));
